# Direct Colab implementation - paste this in a new cell
...
# Calculate class weights from your existing data
...
# Create training arguments with proven hyperparameters
...
# Evaluate and create new confusion matrix
print("\nEvaluating with weighted loss...")
...
plt.title("Confusion Matrix - After Weighted Loss")
